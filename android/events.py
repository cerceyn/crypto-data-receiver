...
PATTERNS = ".!/"
def register(bot: TelegramClient,**args):
    """ Yeni bir etkinlik kaydedin. """
    pattern = args.get('pattern', None)
    patterncorrect = args.get('patterncorrect', True)
    ...
    if pattern:
        args["pattern"] = pattern = pattern.replace("^.", "^["+ PATTERNS + "]")
    if patterncorrect:
    ...
    if 'patterncorrect' in args:
        del args['patterncorrect']
